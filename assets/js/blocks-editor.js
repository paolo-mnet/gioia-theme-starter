...
wp.domReady(function() {
  var unwantedBlocks = ['core/archives', 'core/calendar', 'core/code', 'core/freeform', 'core/preformatted', 'core/audio', 'core/verse', 'core/more', 'core/nextpage', 'core/latest-comments', 'core/loginout', 'core/page-list'];
  var unwantedEmbeds = ['wordpress', 'soundcloud', 'animoto', 'cloudup', 'crowdsignal', 'dailymotion', 'hulu', 'imgur', 'issuu', 'kickstarter', 'meetup-com', 'mixcloud', 'reddit', 'reverbnation', 'screencast', 'scribd', 'smugmug', 'speaker-deck', 'ted', 'tumblr', 'videopress', 'wordpress-tv', 'amazon-kindle', 'wolfram-cloud'];
